...
// 	glfw.SetErrorCallback(glfw_error_callback)
	...
	graphics_context.window = glfw.CreateWindow(1280, 720, str.clone_to_cstring(title), nil, nil)
...
// 	ok:      bool
// 	err_loc: rt.Source_Code_Location
...
// recompile_shader :: proc(draw: ^Draw, working_directory_path: string, shader: ^Shader, allocator: rt.Allocator = context.allocator) {
