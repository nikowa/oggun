...
UI_Manager :: struct {
	...
	theme: ^UI_Theme,
	button_shape_stack, button_shape_stack_store: [dynamic]UI_Button_Shape,
	appearance_stack, appearance_stack_store: [dynamic]UI_Appearance,
...
UI_Theme :: [len(UI_Theme_Key)]UI_Color
...
UI_FONT_SIZE_CAPTION_2 ::   10
UI_FONT_SIZE_CAPTION_1 ::   12
UI_FONT_SIZE_BODY_1 ::      14
UI_FONT_SIZE_BODY_2 ::      16
UI_FONT_SIZE_SUBTITLE_2 ::  16
UI_FONT_SIZE_SUBTITLE_1 ::  20
UI_FONT_SIZE_TITLE_3 ::     24
UI_FONT_SIZE_TITLE_2 ::     28
UI_FONT_SIZE_TITLE_1 ::     32
UI_FONT_SIZE_LARGE_TITLE :: 40
UI_FONT_SIZE_DISPLAY ::     68
...
UI_RADIUS_LARGE   :: 6
UI_RADIUS_XLARGE  :: 8
UI_RADIUS_XLARGE2 :: 12
UI_RADIUS_XLARGE3 :: 16
UI_RADIUS_XLARGE4 :: 24
UI_RADIUS_XLARGE5 :: 32
UI_RADIUS_XLARGE6 :: 40

UI_STROKE_THIN     :: 1
UI_STROKE_THICK    :: 2
UI_STROKE_THICKER  :: 3
UI_STROKE_THICKEST :: 4
...
UI_BUTTON_SIZE_SMALL:  [2]f32 : { 64, 24 }
UI_BUTTON_SIZE_MEDIUM: [2]f32 : { 96, 32 }
UI_BUTTON_SIZE_LARGE:  [2]f32 : { 96, 40 }
UI_ICON_SIZE:          [2]f32 : { 24, 24 }
UI_AVATAR_SIZE:        [2]f32 : { 32, 32 }
UI_BADGE_SIZE_S:       [2]f32 : { 10, 10 }
UI_BADGE_SIZE_M:       [2]f32 : { 16, 16 }
UI_BADGE_SIZE_L:       [2]f32 : { 20, 20 }
...
ui_init :: proc() {
	...
	ui_theme_ms_light = new(UI_Theme)
	ui_theme_ms_dark = new(UI_Theme)
	ui_theme_ms_light^ = {
		NEUTRAL_FOREGROUND_1 = {
...
ui_chevron :: proc(position: [2]f32, header: string, panel_size: [2]f32, location := #caller_location) -> (panel: Rect) {
	return ui_chevron_begin(position, header, panel_size, location) }
...
@(deferred_out=ui_accordion_end)
ui_accordion :: proc(position: [2]f32, multiple: bool=true, collapsible: bool=true) -> (accordion: ^Accordion) {
	return ui_accordion_begin(position, multiple=multiple, collapsible=collapsible) }

ui_accordion_begin :: proc(position: [2]f32, multiple: bool=true, collapsible: bool=true) -> (accordion: ^Accordion) {
...
ui_accordion_end :: proc(accordion: ^Accordion) {
...
@(deferred_none=gx_clip_pop)
ui_accordion_add :: proc(accordion: ^Accordion, header: string, panel_size: [2]f32, location := #caller_location) -> (panel_rect: Rect) {
	panel_rect = ui_chevron_begin(accordion.position, header, panel_size, location)
	accordion.position.y = rect_bottom(panel_rect) - UI_SPACING_L
	append(&accordion.locations, location)
	return panel_rect }

ui_measure_text :: proc(text: string, scale_factor: f32) -> (width: f32, space_count: int) {
...
ui_measure_text_iterate :: proc(text: string, i: ^int, width: ^f32, space_count: ^int, scale_factor: f32) -> bool {
	using style := ui_text_style_get()
