...
make_bitpacked_array :: proc($Elem_Type: typeid, $elem_size: uint, #any_int len: uint, allocator := context.allocator, loc := #caller_location) -> (array: Bitpacked_Array(Elem_Type, elem_size), err: runtime.Allocator_Error) #optional_allocator_error {
