...
make_mesh_builder :: proc($depth: int, allocator: runtime.Allocator) -> (mesh_builder: Mesh_Builder(depth)) {
...
make_line_cube_mesh :: proc(allocator: runtime.Allocator, radius: f32) -> (mesh: Mesh(3)) {
...
make_line_ground_mesh :: proc(allocator: runtime.Allocator, n: int) -> (mesh: Mesh(3)) {
	mesh_builder := make_mesh_builder(3, allocator)
