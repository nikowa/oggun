...
entry_point :: proc(thread_data: ^oggun.Thread_Data) {
	...
	for engine_running() do if engine_tick() {
		...
		rect_1, rect_2 := ui_rect_split_h(ui_rect_margins(rect_0, Interval(16)), Interval(120), Interval(16))
		gx_depth_push_inc(0.01)
		...
		rects := ui_rect_slice_v(rect_3, Ratio(0.1), 4)
		gx_depth_push_inc(0.01)
		...
		rects_0 := ui_rect_grid_make(ui_rect_margins(rect_4, Interval(8)), { 4, 3 })
		gx_depth_push_inc(0.01)
		for rect in rects_0 do dr_rect(ui_rect_margins(rect, Interval(8)), FILL_1, STROKE, stroke = 1)
		rect_5 := ui_rect_margins(rects_0[ui_rect_grid_index({ 4, 3 }, 1, 0)], Interval(24))
		gx_depth_push_inc(0.01)
		dr_rect(rect_5, FILL_2, STROKE, stroke = 1)
		rect_6 := ui_rect_rotate(rect_5)
		gx_depth_push_inc(0.01)
		dr_rect(rect_6, FILL_1, STROKE, stroke = 1)
		gx_depth_push_inc(0.01)
		dr_rect(ui_rect_mirror_x(rect_6), FILL_1, STROKE, stroke = 1)
		gx_depth_push_inc(0.01)
		dr_rect(ui_rect_mirror_y(rect_6), FILL_1, STROKE, stroke = 1)
		rect_7 := ui_rects_merge(rect_6, ui_rect_mirror_y(rect_6))
		gx_depth_push_inc(0.01)
