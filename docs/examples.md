...
![example-graph](img/example-plot.png)
...
![example-input](img/example-input.png)
...
![example-neon](img/example-neon.png)
...
![example-sprites](img/example-sprites.png)

Draws a bunch of moving sprites. Intended to test command batching.

## Sync

![example-sync](img/example-sync.png)
